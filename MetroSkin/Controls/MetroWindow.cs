...
public class MetroWindow : Window
{
    ...
    public static readonly DependencyProperty SystemButtonColorProperty =
        DependencyProperty.Register("SystemButtonColor", typeof(Brush), typeof(MetroWindow), new PropertyMetadata(new SolidColorBrush(Color.FromArgb(0, 255, 255, 255))));
    ...
    public static readonly DependencyProperty SystemButtonSizeProperty =
        DependencyProperty.Register("SystemButtonSize", typeof(double), typeof(MetroWindow), new PropertyMetadata(35.0));
    ...
    public static readonly DependencyProperty SystemButtonForegroundProperty =
        DependencyProperty.Register("SystemButtonForeground", typeof(Brush), typeof(MetroWindow), new PropertyMetadata(new SolidColorBrush(Color.FromRgb(88, 88, 88))));
    ...
    public static readonly DependencyProperty SystemButtonOverColorProperty =
        DependencyProperty.Register("SystemButtonOverColor", typeof(Brush), typeof(MetroWindow), new PropertyMetadata(new SolidColorBrush(Color.FromRgb(225, 225, 225))));
    ...
    public static readonly DependencyProperty SystemButtonCloseOverColorProperty =
        DependencyProperty.Register("SystemButtonCloseOverColor", typeof(Brush), typeof(MetroWindow), new PropertyMetadata(new SolidColorBrush(Color.FromRgb(232, 17, 35))));
    #endregion
    ...
    public static readonly DependencyProperty CaptionHeightProperty =
        DependencyProperty.Register("CaptionHeight", typeof(double), typeof(MetroWindow), new PropertyMetadata(35.0));
    ...
    public static readonly DependencyProperty CaptionBackgroundProperty =
        DependencyProperty.Register("CaptionBackground", typeof(Brush), typeof(MetroWindow), new PropertyMetadata(new SolidColorBrush(Color.FromArgb(0, 255, 255, 255))));
    ...
    public static readonly DependencyProperty TitleContentProperty =
        DependencyProperty.Register("TitleContent", typeof(UIElement), typeof(MetroWindow), new PropertyMetadata(default));
    ...
    public static readonly DependencyProperty FitSystemWindowProperty =
        DependencyProperty.Register("FitSystemWindow", typeof(bool), typeof(MetroWindow), new PropertyMetadata(default));
    #endregion
